...
export function Footer() {
  return (
    <footer className="w-full bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 py-12 mt-auto animate-in fade-in duration-1000">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-1">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Rankify <span className="text-primary font-light">DTU</span></h2>
        ...
        <div className="pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            ...
            <a
              href="https://github.com/adityakashyaptxt"
              target="_blank"
